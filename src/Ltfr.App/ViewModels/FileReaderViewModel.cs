...
namespace Ltfr.App
{
    public class FileReaderViewModel : BaseViewModel
    {
        ...
        public ObservableCollection<TextLine> Lines { get; private set; } = new ObservableCollection<TextLine>();
        ...
        private async void OnFileBlockRead(object sender, System.Buffers.ReadOnlySequence<byte> e)
        {
